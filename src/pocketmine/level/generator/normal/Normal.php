...
use pocketmine\level\{ChunkManager, Level};
use pocketmine\level\generator\biome\{Biome, BiomeSelector};
...
class Normal extends Generator{
 ...
 protected array $populators = [], $generationPopulators = [];
 protected ChunkManager $level;
 protected Random $random;
 protected int $waterHeight = 62, $bedrockDepth = 5;
 protected Simplex $noiseBase;
 protected BiomeSelector $selector;
 private static $GAUSSIAN_KERNEL = null, $SMOOTH_SIZE = 2;
 ...
 private static function generateKernel() : void{
	...
	public function populateChunk($chunkX, $chunkZ) : void{
		...
		Biome::getBiome($this->level->getChunk($chunkX, $chunkZ)->getBiomeId(7, 7))->populateChunk($this->level, $chunkX, $chunkZ, $this->random);
	}
