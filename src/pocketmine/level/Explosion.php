...
class Explosion{
	...
	public function explodeB() : bool{
		...
		if($this->level->getChunk($this->source->x >> 4, $this->source->z >> 4) != null){
			$this->level->getServer()->getScheduler()->scheduleAsyncTask(new LightPopulationTask($this->level, $this->level->getChunk($this->source->x >> 4, $this->source->z >> 4)));
		}
