...
class Block extends Position implements BlockIds, Metadatable{	
	...
	public static function init(){
		if(self::$list === null){
			...
			self::$list[self::NETHER_WART_BLOCK2] = NetherWartBlock::class;
			...
			self::$list[self::CHORUS_PLANT] = CHORUS_PLANT::class;
			self::$list[self::CHORUS_FLOWER] = CHORUS_FLOWER::class;
			self::$list[self::OBSERVER] = OBSERVER::class;
			self::$list[self::COMPARATOR_BLOCK] = COMPARATOR_BLOCK::class;
