...
self::$list[self::END_CRYSTAL] = EndCrystal::class;
			...
			self::$list[self::LEAD] = LEAD::class;
			self::$list[self::SADDLE] = SADDLE::class;
			self::$list[self::PUFFER_FISH] = PUFFER_FISH::class;
			self::$list[self::RAW_SALMON] = RAW_SALMON::class;
			self::$list[self::COOKED_SALMON] = COOKED_SALMON::class;
self::$list[self::CLOWN_FISH] = CLOWN_FISH::class;
self::$list[self::CHORUS_FRUIT] = CHORUS_FRUIT::class;
self::$list[self::POPPED_CHORUS_FRUIT] = POPPED_CHORUS_FRUIT::class;
self::$list[self::LEATHER_HORSE_ARMOR] = LEATHER_HORSE_ARMOR::class;
self::$list[self::IRON_HORSE_ARMOR] = IRON_HORSE_ARMOR::class;
self::$list[self::GOLD_HORSE_ARMOR] = GOLD_HORSE_ARMOR::class;
self::$list[self::DIAMOND_HORSE_ARMOR] = DIAMOND_HORSE_ARMOR::class;
self::$list[self::BLAZE_ROD] = BLAZE_ROD::class;
self::$list[self::RABBIT_HIDE] = RABBIT_HIDE::class;
self::$list[self::RABBIT_FOOT] = RABBIT_FOOT::class;
self::$list[self::CARROT_ON_A_STICK] = CARROT_ON_A_STICK::class;
self::$list[self::IRON_NUGGET] = IRON_NUGGET::class;
self::$list[self::LINGERING_POTION] = LINGERING_POTION::class;
