...
public function setMetadata(string $metadataKey, MetadataValue $metadataValue) : void{
...
public function removeMetadata(string $metadataKey, Plugin $plugin) : void{
